      ...
      >
        ...
        <div className="w-full md:w-1/2 text-white text-center md:text-left space-y-6 px-10">
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            Diseños pensados para una experiencia de escritorio completa, con
            animaciones fluidas, maquetaciones cuidadas y una interfaz
            atractiva. Desarrollados con React y Framer Motion para ofrecer
