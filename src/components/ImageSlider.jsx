  ...
  return (
    ...
    >
      ...
      {/* <button
        ...
        className="absolute bottom-6 right-6 z-20 bg-white/30 hover:bg-white/60 text-black rounded-full p-3 transition duration-300"
      ...
      {/* Text Overlay */}
    {/* Overlay */}
<div className="absolute inset-0 bg-red-300/20 z-10 flex flex-col items-center justify-center text-center px-4">
  ...
  <div className="mt-6 flex justify-center">
    ...
    >
      ...
      {/* Navigation Buttons */}
      <button
        className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/30 hover:bg-white/60 text-black rounded-full p-2 transition duration-300"
        onClick={() => swiperRef.current?.slidePrev()}
      >
        <BsChevronLeft className="w-6 h-6" />
      </button>
       <button
        className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/30 hover:bg-white/60 text-black rounded-full p-2 transition duration-300"
